...
public class KafkaProducer {
  ...
  public void send(String workflowInstanceId, JobExecution execution) {
    logger.debug("Sending {}", execution);

    final KeyedMessage<String, String> message =
        new KeyedMessage<String, String>(producerConfiguration.getTopic(), workflowInstanceId,
            JobExecutionUtils.toJson(execution));
